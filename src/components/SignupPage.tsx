...
export function SignupPage({ onNavigate, onSignup }: SignupPageProps) {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-green-50 py-12">
      <div className="container mx-auto px-4">
        <Card className="max-w-md mx-auto p-8">
          {/* Logo */}
          <div className="flex justify-center mb-8">
            <img src={logoImage} alt="ComplyPilot" className="h-12" />
          </div>
            ...
            <div className="space-y-2">
              ...
              <Select required>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="ca">CA / Compliance Professional</SelectItem>
          ...
          <div className="relative my-6">
            <Separator />
            <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-3 text-gray-500">
              or
            </span>
          </div>
